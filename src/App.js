...
import Minilogo from "./assets/images/Black Logo 1.png";
import Profile from "./assets/images/faces/face1.jpg";
import $ from "jquery";
function App() {
  ...
  return (
    <>
              ...
              <li class="nav-item nav-profile dropdown">
                ...
                >
                  <a class="dropdown-item" href="#">
                    <i class="mdi mdi-cached me-2 text-success"></i> Activity
                    Log{" "}
                  </a>
        ...
        <div class="container-fluid page-body-wrapper">
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="pages/tables/basic-table.html">
                  <span class="menu-title">Files Multiple</span>
                  <i class="fa-solid fa-clone"></i>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="pages/tables/basic-table.html">
                  <span class="menu-title">Attach</span>
      ...
      <script
        src="../src/assets/js/jquery.cookie.js"
